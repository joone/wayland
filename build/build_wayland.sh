...
#git reset --hard
#git pull
./autogen.sh --prefix=$WLD --enable-gles2 --disable-gallium-egl --with-egl-platforms=x11,wayland,drm --enable-gbm --enable-shared-glapi --with-gallium-drivers=r300,r600,swrast,nouveau  --disable-dri3
make
make install
cd ..
###########################################################
...
#git reset --hard
#git pull
./autogen.sh --prefix=$WLD --with-xkb-config-root=/usr/share/X11/xkb --disable-x11
make
make install
cd ..
###########################################################
